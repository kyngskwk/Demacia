...
urlpatterns = [
    #챔피언추천
    path('usersearch/', views.user_search, name="user search"),
    ...
    path('videoposts/update/', views.videopost_update, name="video update"),
    path('videoposts/<int:videopostno>', views.videopost_list, name="video list"),
