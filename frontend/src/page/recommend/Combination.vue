        ...
        <b-col>
          ...
          <b-row align-v="center">
            <b-col>
              ...
              />
              <b-badge pill variant="warning" class="pickname">{{comb_info[2].korname}} | {{comb_info[2].chamname}}</b-badge>
            </b-col>
            <b-col>
              <b-img
                      style="border-style:ridge; border: #fcd000 3px ridge;"
              ...
              />
              <b-badge pill variant="warning" class="pickname">{{comb_info[3].korname}} | {{comb_info[3].chamname}}</b-badge>
            </b-col>
            </b-row>
        </b-col>
        ...
        <b-col class="article">
          ...
          <b-row align-v="center">
            <b-col>
              ...
              />
              <b-badge pill variant="warning" class="pickname">{{comb_info[6].korname}} | {{comb_info[6].chamname}}</b-badge>
            </b-col>
            <b-col>
              <b-img
                      style="border-style:ridge; border: #fcd000 3px ridge;"
              ...
              />
              <b-badge pill variant="warning" class="pickname">{{comb_info[7].korname}} | {{comb_info[7].chamname}}</b-badge>
            </b-col>
          </b-row>
        </b-col>
        ...
        <b-col>
          ...
          <b-row align-v="center">
            <b-col>
              ...
              />
              <b-badge pill variant="warning" class="pickname">{{comb_info[10].korname}} | {{comb_info[10].chamname}}</b-badge>
            </b-col>
            <b-col>
              <b-img
                      style="border-style:ridge; border: #fcd000 3px ridge;"
              ...
              />
              <b-badge pill variant="warning" class="pickname">{{comb_info[11].korname}} | {{comb_info[11].chamname}}</b-badge>
            </b-col>
          </b-row>
        </b-col>
      </b-row>
